require.config({
	paths:{
		...
		TypeMainView:'view/TypeMainView',
		TypeEditView:'view/TypeEditView',
		TypeRouter:'router/TypeRouter'
	},
	shim : {  
    	bootstrap : {  
        	deps : ['jquery'],  
...
define(['jquery','underscore','backbone','bootstrap','TypeRouter'],
	function ($,_,Backbone,bootstrap,TypeRouter) {
	...
	// 		var op=this.assetView.operations.get(id).toJSON();
